...
export default function Home() {
	return (
		<div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white dark:from-zinc-900 dark:to-zinc-800 p-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
					<div className="p-6 bg-white dark:bg-zinc-800 rounded-xl shadow-sm">
						...
						<p className="text-sm text-zinc-500 dark:text-zinc-400">
							Access groundwater reports for all Indian states and union
							territories
						</p>
					</div>
					<div className="p-6 bg-white dark:bg-zinc-800 rounded-xl shadow-sm">
