  ...
  return (
    <>
      <div className="text-center mb-10 flex items-center justify-center flex-col">
        ...
        <p className="text-zinc-400 text-base">How can I assist you today?</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto mb-6 auto-rows-fr">
        {[
          {
          ...
          },
          {
            ...
            description: (
              <>Analyze extraction changes in {userLocation.state}</>
            ),
